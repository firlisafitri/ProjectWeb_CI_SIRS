                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-0 text-white"><i class="fas fa-user"></i> &nbsp;&nbsp;&nbsp;Data Mahasiswa UCIC</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url().'index.php/Admin/Admin/data_mhs_edit/'.$mhs->id_mhs.' '?>" class="btn btn-success">Edit</a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
